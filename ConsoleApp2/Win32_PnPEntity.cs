namespace ROOT.CIMV2.Win32 {
    ...
    // Eine für die WMI-Klasse generierte Klasse mit früher Bindung.Win32_PnPEntity
    public class PnPEntity : System.ComponentModel.Component {
        ...
        private static string CreatedClassName = "Win32_PnPEntity";
        ...
        public PnPEntity(string keyDeviceID) {
            this.InitializeObject(null, new System.Management.ManagementPath(PnPEntity.ConstructPath(keyDeviceID)), null);
        }
        
        public PnPEntity(System.Management.ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(PnPEntity.ConstructPath(keyDeviceID)), null);
        }
        
        public PnPEntity(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public PnPEntity(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public PnPEntity(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public PnPEntity(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public PnPEntity(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public PnPEntity(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"ClassGuid\" gibt die GUID (Globally Unique Identifier) für das Pl" +
            "ug & Play-Gerät an.")]
        public string ClassGuid {
            get {
                return ((string)(curObj["ClassGuid"]));
            }
        }
        
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Liste von kompatiblen IDs für das Gerät. Wenn Setup keine mit einer der Hardware-" +
            "IDs des Geräts übereinstimmende INF-Datei findet, sucht es anhand der kompatible" +
            "n IDs nach einer INF-Datei.")]
        public string[] CompatibleID {
            get {
                return ((string[])(curObj["CompatibleID"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DeviceID\" enthält eine Zeichenfolge, die das Plug & Play-Gerät a" +
            "ngibt.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Liste von Hardware-IDs für das Gerät. Eine Hardware-ID ist eine vom Lieferanten d" +
            "efinierte Identifikationszeichenfolge, anhand derer Setup ein Gerät einer INF-Da" +
            "tei zuordnet.")]
        public string[] HardwareID {
            get {
                return ((string[])(curObj["HardwareID"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Manufacturer\" gibt den Hersteller des Plug & Play-Geräts an.\nBei" +
            "spiel: Acme")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Service\" gibt den Namen des Dienstes an, der das Plug & Play-Ger" +
            "ät unterstützt. Siehe auch: \"Win32_SystemDriverPNPEntity\".\nBeispiel: atapi")]
        public string Service {
            get {
                return ((string)(curObj["Service"]));
            }
        }
        ...
        private static string ConstructPath(string keyDeviceID) {
            string strPath = "root\\cimv2:Win32_PnPEntity";
        ...
        public static PnPEntityCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static PnPEntityCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static PnPEntityCollection GetInstances(System.String [] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static PnPEntityCollection GetInstances(string condition, System.String [] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static PnPEntityCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "Win32_PnPEntity";
            ...
            return new PnPEntityCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static PnPEntityCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static PnPEntityCollection GetInstances(System.Management.ManagementScope mgmtScope, System.String [] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static PnPEntityCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String [] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\cimv2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_PnPEntity", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new PnPEntityCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static PnPEntity CreateInstance() {
            ...
            return new PnPEntity(tmpMgmtClass.CreateInstance());
        }
        ...
        public class PnPEntityCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public PnPEntityCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new PnPEntity(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual System.Collections.IEnumerator GetEnumerator() {
                return new PnPEntityEnumerator(privColObj.GetEnumerator());
            }
            
            public class PnPEntityEnumerator : object, System.Collections.IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public PnPEntityEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new PnPEntity(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
